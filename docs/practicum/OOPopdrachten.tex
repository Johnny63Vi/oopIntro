...
\makeatletter
\newcommand{\listofopdrachten}{%
	\section*{Lijst van opdrachten}%
	\addcontentsline{toc}{section}{Lijst van opdrachten}%
	\@starttoc{lop}%
}

\newcommand*\l@opdracht{\@dottedtocline{1}{1.5em}{2.3em}}
\makeatother

% ===== Opdracht box =====
\newtcolorbox{opdrachtbox}[1][]{
	colback=gray!10,
	colframe=black,
	fonttitle=\bfseries,
	#1
...
\newenvironment{opdracht}[1][]
{
	...
	% toevoegen aan lijst
	\addcontentsline{lop}{opdracht}{\protect\numberline{\theopdracht}#1}
	
	\begin{opdrachtbox}[title=Opdracht \theopdracht: #1]
	}
	{
	\end{opdrachtbox}
}
