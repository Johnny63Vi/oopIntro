...
Voor het practicum \texttt{Introductie Object Georiënteerd Programmeren} zijn (ongeveer) 25 RockPi’s beschikbaar. Dit zijn Raspberry Pi achtige ‘Single Board Computers’ die met een Linux variant werken, in dit geval Debian 10. De RockPi’s zijn aangeschaft omdat Raspberry Pi’s niet leverbaar (of te duur) waren.
...
De RockPi is al ingesteld voor Wi-Fi netwerk in D2.001: \textbf{NSELab}. \newline
Log ook met je laptop in op dit netwerk. Het password in 2026 is \textbf{NSELabWiFi}. \newline
